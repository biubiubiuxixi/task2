...
var __parent0=require('$model/UI2/cxxy/bottom/means'); 
var __result = __parent2._extend(__parent1)._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cvQjQZf';
	this._flag_='fb252c1fed3f392752e6be3e864f5a23';
