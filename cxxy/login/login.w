...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="memberData" queryAction="queryUser" saveAction="saveUser" url="/justep/h5db" tableName="user" idColumn="uId"><column label="个人用户编号" name="uId" type="String" xid="default1"></column>
  ...
  <div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="phone1Data" queryAction="queryPhonedata" saveAction="savePhonedata" url="/justep/h5db" tableName="phonedata" idColumn="ID" confirmDelete="false"><column label="ID" name="ID" type="String" xid="default22"></column>
  <column label="phone" name="phone" type="String" xid="default23"></column></div></div>  
   ...
   <span xid="span1"></span></a></div>
    ...
    <div class="x-titlebar-right reverse" xid="right1">
      ...
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        class="x-control-group" title="用户登录" xid="controlGroup1" style="margin-bottom:40px;margin-top:20px;"> 
        ...
        <div component="$UI/system/components/justep/row/row" class="x-row"
          ...
          <div class="x-col x-col-20" xid="col5"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link"
              label="密    码：" xid="button3" style="color:#000000;width:100%;text-align:right;"> 
              <i xid="i6"/>  
              <span xid="span10">密    码：</span>
            </a> 
          </div>  
          <div class="x-col" xid="col6"> 
            <input component="$UI/system/components/justep/input/password" class="form-control" xid="passwordInput"></input></div> 
        </div>  
        <a component="$UI/system/components/justep/button/button" class="btn x-green btn-only-label btn-block list-group"
          label="登录" xid="loginBtn" style="margin-bottom:10px;border-color:#C0C0C0 #C0C0C0 #C0C0C0 #C0C0C0;margin-top:10px;"
          onClick="loginBtnClick"> 
          <i xid="i7"/>  
          <span xid="span11">登录</span>
        </a>  
        <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col9"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-icon-right pull-right" label="注册" xid="regbtn" onClick="regbtnClick">
   <i xid="i2"></i>
   <span xid="span2">注册</span></a></div>
   <div class="x-col x-col-fixed" xid="col11" style="width:auto;"><span xid="span3"><![CDATA[|]]></span></div>
  <div class="x-col" xid="col12"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-icon-right pull-left" label="忘记密码" xid="forgetBtn">
   <i xid="i3"></i>
   <span xid="span4">忘记密码</span></a></div></div></div>
