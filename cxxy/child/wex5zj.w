...
<div class="x-titlebar" component="$UI/system/components/justep/titleBar/titleBar" style="font-size:18px;background-color:#68c398;" xid="titleBar11111_17" xui:update-mode="merge" >
<div class="x-titlebar-left" xid="left11111_17" >
<a class="btn btn-link btn-only-icon" component="$UI/system/components/justep/button/button" icon="icon-chevron-left" label="button" onClick="{operation:'window.close'}" xid="button21111_17" >
<i class="icon-chevron-left" xid="i11111_17" />
<span xid="span11111_17" />
</a>
</div>
<div class="x-titlebar-title" xid="title11111_17" xui:update-mode="merge-and-replace" >
<span xid="span11_17" >
电子版教材</span>
</div>
<div class="x-titlebar-right reverse" xid="right11111_17" />
</div>
</div>
   <div xid="content1" _xid="C77F378195000001179FB7A013CCD2A0" style="bottom: 0px;"  xui:update-mode="merge"/>
    <iframe height="100%" src="http://pan.baidu.com/s/1dERYDRN" width="100%" xid="iframe11_7" xui:parent="content1" xui:update-mode="insert" />
