...
var __result = __parent2._extend(__parent1)._extend(__parent0).extend({
 ...
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"id":{"define":"id","label":"编号","name":"id","relation":"id","type":"String"},"title":{"define":"title","label":"标题","name":"title","relation":"title","type":"String"},"url":{"define":"url","label":"地址","name":"url","relation":"url","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"zxDataCustomRefresh"},"idColumn":"id","limit":20,"xid":"zxData"});
}}); 
return __result;});
