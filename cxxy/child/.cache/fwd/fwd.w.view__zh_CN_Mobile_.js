...
var __parent0=require('$model/UI2/cxxy/child/fwd'); 
var __result = __parent2._extend(__parent1)._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='ceIvmia';
	this._flag_='347743130867992e5de45721a36bc957';
