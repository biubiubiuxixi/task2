...
var __parent0=require('$model/UI2/cxxy/child/css'); 
var __result = __parent2._extend(__parent1)._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cNzueMf';
	this._flag_='67c5d9d1cf326fd45144a53c0530df6e';
