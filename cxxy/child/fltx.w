...
<i class="text-muted icon-ios7-arrow-up" xid="i511_12" />
</a>
<h5 class="text-muted" xid="h521_12" >
请选择</h5>
...
<div bind-css="{'active':navRow.val('fID')==$model.navData.val('fID')}" class="btn btn-link" xid="div61_12" >
...
[]</data>
   ...
   <span xid="span7"  xui:update-mode="merge-and-replace">师资培训</span>   <a xid="wordBtn" label="联合科研"  xui:update-mode="merge"/>
   <span xid="span8"  xui:update-mode="merge-and-replace">联合科研</span>   <a xid="readBtn" label="专业共建"  xui:update-mode="merge"/>
   <span xid="span9"  xui:update-mode="merge-and-replace">专业共建</span>   <a xid="listenBtn" label="学习论坛"  xui:update-mode="merge"/>
   <span xid="span10"  xui:update-mode="merge-and-replace">学习论坛</span>   <a xid="studyBtn" label="考试认证"  xui:update-mode="merge"/>
   <span xid="span11"  xui:update-mode="merge-and-replace">考试认证</span>   <a xid="aboutBtn" label="个人中心"  xui:update-mode="merge"/>
   <span xid="span12"  xui:update-mode="merge-and-replace">个人中心</span>    <div class="x-panel-top" xid="top1" xui:before="content1" xui:parent="panel1" xui:update-mode="insert" >
...
<div class="x-titlebar-right reverse" xid="right1111_6" >
   ...
   <div xid="content1" _xid="C77F378195000001179FB7A013CCD2A0" style="bottom: 0px;"  xui:update-mode="merge"/>
    <iframe height="100%" src="http://pan.baidu.com/s/1i4RkDyX#list/path=%2F" width="100%" xid="iframe11_7" xui:parent="content1" xui:update-mode="insert" />
